...
/**
 * Iterates thought the given {@link ConnectorPosition}s and returns the first valid position from the given
 * implementations.
 * 
 * @author brabenetz
 */
public class ConnectorPositionFirstValid implements ConnectorPosition {
    ...
    public int getPosition(final List<Connector> connectors) {
        for (final ConnectorPosition connectorPosition : connectorPositions) {
