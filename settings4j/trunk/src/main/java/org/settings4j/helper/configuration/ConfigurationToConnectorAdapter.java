...
/**
 * Adapter to use an <a href="http://commons.apache.org/proper/commons-configuration/">Apache Commons Configuration</a>
 * as Settings4j connector.
 * <p>
 * <h3>Example Usage</h3><br />
 * Create a {@link org.apache.commons.configuration.XMLConfiguration} instance and add it to the Settings4j instance as
 * Connector.
 * 
 * <pre>
