 ...
 *
 */
public class ConnectorPositionAfterLastClass implements ConnectorPosition {
     ...
     */
    public ConnectorPositionAfterLastClass(final Class<? extends Connector> connectorClass) {
        super();
