 ...
 * @author brabenetz
 */
public class ConnectorPositionAfterFirstClass implements ConnectorPosition {
     ...
     */
    public ConnectorPositionAfterFirstClass(final Class<? extends Connector> connectorClass) {
        super();
