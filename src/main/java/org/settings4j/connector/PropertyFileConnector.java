 ...
 * </pre>
 * <p>
 * You can also use other connectors which have a nativ implementation for {@link org.settings4j.Connector#getContent(String)} (doesn't use contentResolver).
 * <br>
 * e.g.: {@link FSConnector} for FileSystem paths.
 * </p>
 * <p>
 * Example usage read property File from Classpath with {@link ClasspathConnector}: <br>
 * If you don't like ExpressionLanguage, then you can set the path to your PropertyFile directly. But in this case a prefix "file:" or "classpath" is required.
 * And only "file:" and "classpath" are supported.<br>
