...
public interface Settings4jInstance {
    ...
    /**
     * Add a custom {@link Connector} to the right position in relation to the other connectors.
     * <p>
     ...
     * <p>
     * <code>{@link ConnectorPositions}.afterLast(SystemPropertyConnector.class)</code> will throw an exception if the {@link Settings4jInstance} doesn't have a
     * SystemPropertyConnector. <br>
     ...
     * To prevent this Exception you should also check with {@link #getConnector(String)} if the Connector already exists:
     * </p>
     *
     * <pre>
     * --------------------------------------
     ...
     *        The connector to add.
     * @param position
     *        The position where the connector should be added.
     */
     ...
     * should return the configured value under "global/datasource"
     * </p>
     *
