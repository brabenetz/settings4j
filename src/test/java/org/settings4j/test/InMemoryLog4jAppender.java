...
public class InMemoryLog4jAppender extends AppenderSkeleton {
    ...
    /**
     * Returns the number of lines in this list. If this list contains more than <tt>Integer.MAX_VALUE</tt> elements, returns <tt>Integer.MAX_VALUE</tt>.
     *
    ...
    /**
     * Removes all of the lines from this list (optional operation). This list will be empty after this call returns (unless it throws an exception).
     */
